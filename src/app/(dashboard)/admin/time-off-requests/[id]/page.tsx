...
import { getDetailedRequestById } from "@/lib/db";
...
const RequestDetailsPage = async ({
  ...
  // Ensure the admin belongs to the same company as the employee who made the request
  if (user.companyId !== request.employee.companyId.toString()) {
    ...
    <div className="space-y-8 mt-12">
      <div className="flex items-center justify-between">
        <div className="flex flex-col space-y-2">
          ...
          >
            &larr; Back to Time Off Requests
          </Link>
          ...
          <div className="px-6 pb-6">
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="space-y-1">
                ...
                <dd>{request.employee.department || "N/A"}</dd>
              </div>
            </div>
          </div>
        </div>
